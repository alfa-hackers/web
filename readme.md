...
- [dev.whirav.ru](https://dev.whirav.ru/)
...
> ⚠️ **Сложность инфраструктуры**: Из-за ограниченных временных рамок полная инфраструктура(STAGE/DEV) не была полностью докеризирована. Некоторые сервисы могут требовать ручной настройки. Активно работаем над полной Docker Compose-оркестрацией.
